...
class DiffMatchPatch {
  ...
  List<Diff> diffMain(String? text1, String? text2,
    ...
    diffs = _diffCompute(text1, text2, checklines, deadline);
  ...
  List<Diff> _diffCompute(
    ...
    final hm = _diffHalfMatch(text1, text2);
    if (hm != null) {
    ...
    return _diffBisect(text1, text2, deadline);
  }
  ...
  List<Diff> _diffLineMode(String text1, String text2, DateTime deadline) {
    ...
    final a = _diffLinesToChars(text1, text2);
    text1 = a['chars1'];
    text2 = a['chars2'];
    ...
    _diffCharsToLines(diffs, linearray);
  ...
  /// Returns a List of Diff objects.
  List<Diff> _diffBisect(String text1, String text2, DateTime deadline) {
    ...
    final v1 = List.filled(vLength, 0);
    final v2 = List.filled(vLength, 0);
  ...
  List<Diff> testDiffBisect(String text1, String text2, DateTime deadline) {
    return _diffBisect(text1, text2, deadline);
  }
  ...
  Map<String, dynamic> _diffLinesToChars(String text1, String text2) {
    ...
    String chars1 = _diffLinesToCharsMunge(text1, lineArray, lineHash, 40000);
    String chars2 = _diffLinesToCharsMunge(text2, lineArray, lineHash, 65535);
    return {'chars1': chars1, 'chars2': chars2, 'lineArray': lineArray};
  }

  /// Hack to allow unit tests to call private method.  Do not use.
  Map<String, dynamic> testDiffLinesToChars(String text1, String text2) {
    return _diffLinesToChars(text1, text2);
  }
  ...
  String _diffLinesToCharsMunge(String text, List<String> lineArray,
  ...
  /// [lineArray] is a List of unique strings.
  void _diffCharsToLines(List<Diff> diffs, List<String> lineArray) {
  ...
  /// Hack to allow unit tests to call private method.  Do not use.
  void testDiffCharsToLines(List<Diff> diffs, List<String> lineArray) {
    _diffCharsToLines(diffs, lineArray);
  }
  ...
  int _diffCommonOverlap(String text1, String text2) {
  ...
  /// Hack to allow unit tests to call private method.  Do not use.
  int testDiffCommonOverlap(String text1, String text2) {
    return _diffCommonOverlap(text1, text2);
  }
  ...
  List<String>? _diffHalfMatch(String text1, String text2) {
    if (diffTimeout <= 0) {
  ...
  /// Hack to allow unit tests to call private method.  Do not use.
  List<String>? testDiffHalfMatch(String text1, String text2) {
    return _diffHalfMatch(text1, text2);
  }
  ...
  List<String>? _diffHalfMatchI(String longtext, String shorttext, int i) {
    ...
    while ((j = shorttext.indexOf(seed, j + 1)) != -1) {
      int prefixLength =
          diffCommonPrefix(longtext.substring(i), shorttext.substring(j));
      int suffixLength =
          diffCommonSuffix(longtext.substring(0, i), shorttext.substring(0, j));
  ...
  void diffCleanupSemantic(List<Diff> diffs) {
    ...
    _diffCleanupSemanticLossless(diffs);
    ...
    while (pointer < diffs.length) {
      if (diffs[pointer - 1].operation == Operation.delete &&
        ...
        int overlapLength1 = _diffCommonOverlap(deletion, insertion);
        int overlapLength2 = _diffCommonOverlap(insertion, deletion);
  ...
  /// Hack to allow unit tests to call private method.  Do not use.
  void testDiffCleanupSemanticLossless(List<Diff> diffs) {
    _diffCleanupSemanticLossless(diffs);
  }
  ...
  String diffToDelta(List<Diff> diffs) {
    final text = StringBuffer();
    for (Diff aDiff in diffs) {
      switch (aDiff.operation) {
        case Operation.insert:
  ...
  List<Diff> diffFromDelta(String text1, String delta) {
    final diffs = <Diff>[];
  ...
  int matchMain(String? text, String? pattern, int loc) {
    // Check for null inputs.
    ...
    if (text == pattern) {
      ...
      // Do a fuzzy compare.
      return _matchBitap(text, pattern, loc);
    }
  }
  ...
  /// [loc] is the location to search around.
  /// Returns the best match index or -1.
  int _matchBitap(String text, String pattern, int loc) {
    ...
    if (bestLoc != -1) {
      scoreThreshold =
          min(_matchBitapScore(0, bestLoc, loc, pattern), scoreThreshold);
    ...
    for (int d = 0; d < pattern.length; d++) {
      ...
      binMid = binMax;
      while (binMin < binMid) {
        if (_matchBitapScore(d, loc + binMid, loc, pattern) <= scoreThreshold) {
          binMin = binMid;
        } else {
          binMax = binMid;
        }
      ...
      final rd = List.filled(finish + 2, 0);
      rd[finish + 1] = (1 << d) - 1;
      for (int j = finish; j >= start; j--) {
        ...
        if ((rd[j] & matchmask) != 0) {
          double score = _matchBitapScore(d, j - 1, loc, pattern);
      ...
      if (_matchBitapScore(d + 1, loc, loc, pattern) > scoreThreshold) {
  ...
  /// Hack to allow unit tests to call private method.  Do not use.
  int testMatchBitap(String text, String pattern, int loc) {
    return _matchBitap(text, pattern, loc);
  }
  ...
  double _matchBitapScore(int e, int x, int loc, String pattern) {
  ...
  void _patchAddContext(Patch patch, String text) {
    if (text.isEmpty) {
      return;
    }
  ...
  /// Hack to allow unit tests to call private method.  Do not use.
  void testPatchAddContext(Patch patch, String text) {
    _patchAddContext(patch, text);
  }
  ...
  List<Patch> patchMake(a, [optB, optC]) {
    String text1;
    List<Diff> diffs;
        ...
        case Operation.equal:
          ...
          if (aDiff.text.length >= 2 * patchMargin) {
            ...
            if (patch.diffs.isNotEmpty) {
              _patchAddContext(patch, prepatchText);
              patches.add(patch);
              patch = Patch();
  ...
  List patchApply(List<Patch> patches, String text) {
    ...
    final nullPadding = patchAddPadding(patches);
    ...
    for (Patch aPatch in patches) {
      ...
      if (text1.length > matchMaxBits) {
        ...
        // a monster delete.
        startLoc =
            matchMain(text, text1.substring(0, matchMaxBits), expectedLoc);
        if (startLoc != -1) {
          endLoc = matchMain(text, text1.substring(text1.length - matchMaxBits),
      ...
      if (startLoc == -1) {
        ...
        if (text1 == text2) {
          ...
          if (text1.length > matchMaxBits &&
              diffLevenshtein(diffs) / text1.length > patchDeleteThreshold) {
  ...
  String patchAddPadding(List<Patch> patches) {
  ...
  /// Intended to be called only from within patch_apply.
  /// [patches] is a List of Patch objects.
  patchSplitMax(List<Patch> patches) {
  ...
  List<Patch> patchFromText(String textline) {
    ...
    while (textPointer < text.length) {
      final m = patchHeader.firstMatch(text[textPointer]);
      if (m == null) {
      ...
      if (group2 == null || group2.isEmpty) {
        ...
        patch.start1--;
        patch.length1 = int.parse(group2);
      }
      ...
      while (textPointer < text.length) {
        if (text[textPointer].isNotEmpty) {
          ...
          try {
            ...
            // Malformed URI sequence.
            throw ArgumentError('Illegal escape in patch_fromText: $ex');
          }
          if (sign == '-') {
            // Deletion.
